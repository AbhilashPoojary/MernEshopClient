...
import { editProductCall } from "../../redux/slice/allProductSlice";
import Util from "../Util";

export default function ProductEditModal({ setShowModalEdit, modalId, toast }) {
  ...
  useEffect(() => {
    ...
    setProductPic(selectedProduct?.imgUrl);
